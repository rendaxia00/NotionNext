...
const BLOG = {
  ...
  NOTION_PAGE_ID:
        process.env.NOTION_PAGE_ID || 'e5ababb5848c49e88ce01b39b3c22204',
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || '我是Pi Network中文布道者, Pi Network是一个基于恒星共识协议（SCP）的区块链项目',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || true, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '布道大师', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Pi Network中文布道者', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://tangly1024.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客, Pi, Pi Network, Web3, 挖坑, 节点, 派, Pi node', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'jhonsonmartin1021@gmail.com', // 邮箱地址 例如mail@tangly1024.com
  ...
  COMMENT_CUSDIS_APP_ID: process.env.NEXT_PUBLIC_COMMENT_CUSDIS_APP_ID || 'bca9c503-ca60-4ab2-864f-23dc9fa2431a', // data-app-id 36位 see https://cusdis.com/
  COMMENT_CUSDIS_HOST:
